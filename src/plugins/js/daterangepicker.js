  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    this.container
      ...
      .on(
        ...
        ".prev_year",
        $.proxy(this.clickPrevYear, this)
      )
      .on(
        "click.daterangepicker",
        ".prev_month",
        $.proxy(this.clickNextYear, this)
      )
      .on(
        "click.daterangepicker",
        "td.available",
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      if (
        ...
        html +=
          '<th class="prev available"><i class="icon iconfont icon-danxian-zuojiantou glyphicon"></i></th>';
      } else {
        html += "<th></th>";
      }
      ...
      if (
        ...
        html +=
          '<th class="next available"><i class="icon iconfont icon-danxian-youjiantou glyphicon"></i></th>';
      } else {
        html += "<th></th>";
      }
