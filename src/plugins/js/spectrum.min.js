!(function (t) {
    ...
    for (var n = [], i = 0; i < t.length; i++) {
      ...
      if (s) {
        ...
        var c = o.toString(a.preferredFormat || "rgb"),
          f = Bt
            ? "background-color:" + o.toRgbString()
            : "filter:" + o.toFilter();
        n.push(
          '<span title="' +
            c +
  ...
  function e(t, e) {
    var r,
      ...
      at = et && !u,
      nt = at
        ? qt(Lt).addClass(d).addClass(f.className).addClass(f.replacerClassName)
        : qt([]),
      it = at ? nt : E,
    ...
    function dt() {
      ...
      I.toggleClass("sp-flat", u),
        I.toggleClass("sp-input-disabled", !f.showInput),
        I.toggleClass("sp-alpha-enabled", f.showAlpha),
        I.toggleClass("sp-clear-enabled", ht),
        I.toggleClass("sp-buttons-disabled", !f.showButtons),
        I.toggleClass("sp-palette-buttons-disabled", !f.togglePaletteOnly),
        I.toggleClass("sp-palette-disabled", !f.showPalette),
        I.toggleClass("sp-palette-only", f.showPaletteOnly),
        I.toggleClass("sp-initial-disabled", !f.showInitial),
        I.addClass(f.className).addClass(f.containerClassName),
        Ot();
    }
    function pt() {
      if (h && window.localStorage) {
        try {
          ...
          1 < t.length &&
            (delete window.localStorage[h],
            qt.each(t, function (t, e) {
              gt(e);
            }));
        } catch (t) {}
        try {
    ...
    function gt(t) {
      if (c) {
        ...
        if (!F[e] && -1 === qt.inArray(e, T))
          for (T.push(e); T.length > O; ) T.shift();
        if (h && window.localStorage)
          try {
    ...
    function mt() {
      (y <= 0 || m <= 0 || _ <= 0) && Ot(),
        ...
        I.addClass(N),
        (j = null),
        E.trigger("dragstart.spectrum", [Mt()]);
    }
    function yt() {
      ...
      b
        ...
        : (E.trigger(t, [Mt()]),
          !1 === p.beforeShow(Mt()) ||
            ...
            (b = !0),
            qt(q).bind("keydown.spectrum", kt),
            qt(q).bind("click.spectrum", St),
            qt(window).bind("resize.spectrum", g),
            nt.addClass("sp-active"),
            I.removeClass("sp-hidden"),
            Ot(),
            Ht(),
            (lt = Mt()),
            vt(),
            p.show(lt),
            E.trigger("show.spectrum", [lt])));
    }
    function kt(t) {
      27 === t.keyCode && Ct();
    }
    ...
    function Ct() {
      b &&
        !u &&
        ((b = !1),
        qt(q).unbind("keydown.spectrum", kt),
        qt(q).unbind("click.spectrum", St),
        qt(window).unbind("resize.spectrum", g),
        nt.removeClass("sp-active"),
        I.addClass("sp-hidden"),
        p.hide(Mt()),
        E.trigger("hide.spectrum", [Mt()]));
    }
    function Pt() {
      At(lt, !0);
    }
    function At(t, e) {
      var r, a;
      tinycolor.equals(t, Mt())
        ? Ht()
        : (!t && ht
            ? (ut = !0)
            : ((ut = !1),
              (a = (r = tinycolor(t)).toHsv()),
              (C = (a.h % 360) / 360),
              (P = a.s),
              (A = a.v),
              (M = a.a)),
          Ht(),
          r && r.isValid() && !e && (ct = f.preferredFormat || r.getFormat()));
    }
    function Mt(t) {
      return (
        (t = t || {}),
        ht && ut
          ? null
          : tinycolor.fromRatio(
              { h: C, s: P, v: A, a: Math.round(100 * M) / 100 },
              { format: t.format || ct }
            )
      );
    }
    ...
    function Ht() {
      ...
      var r = Mt({ format: e }),
        a = "";
      if (
        (st.removeClass("sp-clear-display"),
        st.css("background-color", "transparent"),
        !r && ht)
      )
        ...
        if (
          (Bt || 1 === r.alpha
            ? st.css("background-color", i)
            : (st.css("background-color", "transparent"),
              st.css("filter", r.toFilter())),
          f.showAlpha)
        ) {
          var s = r.toRgb();
          s.a = 0;
          ...
          zt
            ? $.css("filter", tinycolor(o).toFilter({ gradientType: 1 }, n))
            : ($.css("background", "-webkit-" + l),
              $.css("background", "-moz-" + l),
              $.css("background", "-ms-" + l),
              $.css(
                "background",
                "linear-gradient(to right, " + o + ", " + n + ")"
              ));
        }
        a = r.toString(e);
      }
    ...
    function Ft() {
      var t = P,
        e = A;
      if (ht && ut) X.hide(), V.hide(), L.hide();
      else {
        X.show(), V.show(), L.show();
        var r = t * m,
          a = y - e * y;
        (r = Math.max(-w, Math.min(m - w, r - w))),
          (a = Math.max(-w, Math.min(y - w, a - w))),
          L.css({ top: a + "px", left: r + "px" });
        var n = M * x;
        X.css({ left: n - k / 2 + "px" });
        var i = C * _;
        V.css({ top: i - S + "px" });
    ...
    function Tt(t) {
      var e = Mt(),
        r = "";
      e && ((r = e.toString(ct)), gt(e)),
        et && E.val(r),
        t && (p.change(e), E.trigger("change", [e]));
    }
    function Ot() {
        ...
        u ||
          ...
          f.offset
            ...
            : I.offset(
                ...
                (i = t[0].ownerDocument),
                (s = i.documentElement),
                (o = s.clientWidth + qt(i).scrollLeft()),
                (l = s.clientHeight + qt(i).scrollTop()),
                ((c = e.offset()).top += n),
                (c.left -= Math.min(
                  c.left,
                  c.left + r > o && r < o ? Math.abs(c.left + r - o) : 0
                )),
                (c.top -= Math.min(
                  c.top,
                  c.top + a > l && a < l ? Math.abs(a + n - 0) : 0
                )),
                c)
              )),
        Ft(),
    ...
    !(function () {
      if (
        (zt && I.find("*:not(input)").attr("unselectable", "on"),
        dt(),
        at && E.after(nt).hide(),
        ht || U.hide(),
        u)
      ...
      function e(t) {
        return (
          t.data && t.data.ignore
            ? (At(qt(t.target).closest(".sp-thumb-el").data("color")), Rt())
            : (At(qt(t.target).closest(".sp-thumb-el").data("color")),
              Rt(),
              Tt(!0),
              f.hideAfterPaletteSelect && Ct()),
          !1
        );
      }
      pt(),
        it.bind("click.spectrum touchstart.spectrum", function (t) {
          D || _t(),
            t.stopPropagation(),
            qt(t.target).is("input") || t.preventDefault();
        }),
        (E.is(":disabled") || !0 === f.disabled) && Nt(),
        I.click($t),
        Y.change(wt),
        Y.bind("paste", function () {
          setTimeout(wt, 1);
        }),
        ...
        J.text(f.cancelText),
        J.bind("click.spectrum", function (t) {
          t.stopPropagation(), t.preventDefault(), Pt(), Ct();
        }),
        U.attr("title", f.clearText),
        U.bind("click.spectrum", function (t) {
          t.stopPropagation(), t.preventDefault(), (ut = !0), Rt(), u && Tt(!0);
        }),
        Z.text(f.chooseText),
        Z.bind("click.spectrum", function (t) {
          t.stopPropagation(),
            t.preventDefault(),
            zt && Y.is(":focus") && Y.trigger("change"),
            Y.hasClass("sp-validation-error") || (Tt(!0), Ct());
        }),
        tt.text(
          f.showPaletteOnly ? f.togglePaletteMoreText : f.togglePaletteLessText
        ),
        tt.bind("click.spectrum", function (t) {
          t.stopPropagation(),
            t.preventDefault(),
            (f.showPaletteOnly = !f.showPaletteOnly),
            f.showPaletteOnly ||
              u ||
              I.css("left", "-=" + (z.outerWidth(!0) + 5)),
            dt();
        }),
        Xt(
          W,
          function (t, e, r) {
            (M = t / x),
              (ut = !1),
              r.shiftKey && (M = Math.round(10 * M) / 10),
              Rt();
          },
          mt,
          yt
          ...
          function (t, e, r) {
            if (r.shiftKey) {
              if (!j) {
                var a = P * m,
                  n = y - A * y,
                  i = Math.abs(t - a) > Math.abs(e - n);
                j = i ? "x" : "y";
              }
            } else j = null;
            var s = !j || "y" === j;
            (!j || "x" === j) && (P = parseFloat(t / m)),
              s && (A = parseFloat((y - e) / y)),
              (ut = !1),
              f.showAlpha || (M = 1),
              Rt();
          },
        ...
        ot
          ? (At(ot),
            Ht(),
            (ct = f.preferredFormat || tinycolor(ot).format),
            gt(ot))
          : Ht(),
        u && xt();
      var r = zt ? "mousedown.spectrum" : "click.spectrum touchstart.spectrum";
      G.delegate(".sp-thumb-el", r, e),
        Q.delegate(".sp-thumb-el:nth-child(1)", r, { ignore: !0 }, e);
    })();
    var jt = {
      show: xt,
      hide: Ct,
      ...
      option: function (t, e) {
        return t === Et
          ...
          ? f[t]
          : ((f[t] = e),
            "preferredFormat" === t && (ct = f.preferredFormat),
            void dt());
      },
      enable: function () {
      ...
      destroy: function () {
        E.show(),
          it.unbind("click.spectrum touchstart.spectrum"),
          I.remove(),
          nt.remove(),
          (It[jt.id] = null);
      },
  ...
  function Xt(s, o, e, t) {
    ...
    function g() {
      c &&
        (qt(l).unbind(r),
        qt(l.body).removeClass("sp-dragging"),
        setTimeout(function () {
          t.apply(s, arguments);
        }, 0)),
        (c = !1);
    ...
    (r.selectstart = p),
      (r.dragstart = p),
      (r["touchmove mousemove"] = a),
      (r["touchend mouseup"] = g),
      qt(s).bind("touchstart mousedown", function (t) {
        (t.which ? 3 == t.which : 2 == t.button) ||
          c ||
          (!1 !== e.apply(s, arguments) &&
            ((c = !0),
            (u = qt(s).height()),
            (h = qt(s).width()),
            (f = qt(s).offset()),
            qt(l).bind(r),
            qt(l.body).addClass("sp-dragging"),
            a(t),
            p(t)));
      });
  }
  ...
  (qt.fn.spectrum = function (r, t) {
        ...
        this.each(function () {
          ...
          if (t) {
            ...
            "get" == r
              ...
              ? (a = t.container)
              : "option" == r
              ? (a = t.option.apply(t, n))
              : "destroy" == r
              ? (t.destroy(), qt(this).removeData(i))
              : e.apply(t, n);
          }
        }),
        a
    ...
    (qt.fn.spectrum.load = !0),
    (qt.fn.spectrum.loadOpts = {}),
    (qt.fn.spectrum.draggable = Xt),
    (qt.fn.spectrum.defaults = Dt),
    (qt.fn.spectrum.inputTypeColorSupport = function t() {
    ...
    (qt.spectrum = {}),
    (qt.spectrum.localization = {}),
    (qt.spectrum.palettes = {}),
    (qt.fn.spectrum.processNativeColorInputs = function () {
    ...
    (function () {
            ...
            "object" == typeof t &&
              ...
              t.hasOwnProperty("b")
                ? ((i = t.r),
                  ...
                  (a = !0),
                  (n = "%" === String(t.r).substr(-1) ? "prgb" : "rgb"))
                : t.hasOwnProperty("h") &&
                  t.hasOwnProperty("s") &&
                  t.hasOwnProperty("v")
                ? ((t.s = O(t.s)),
      ...
      function v(t, e) {
        ...
        var r = d(t).toRgb();
        return (
          (r.r = h(0, u(255, r.r - i((-e / 100) * 255)))),
          (r.g = h(0, u(255, r.g - i((-e / 100) * 255)))),
          (r.b = h(0, u(255, r.b - i((-e / 100) * 255)))),
          d(r)
        );
      }
      function m(t, e) {
      ...
      function C(t, e) {
        e = e || 6;
        for (
          var r = d(t).toHsv(), a = r.h, n = r.s, i = r.v, s = [], o = 1 / e;
          e--;
      ...
      (d.prototype = {
        ...
        setAlpha: function (t) {
          return (
            (this._a = M(t)), (this._roundA = i(100 * this._a) / 100), this
          );
        },
        toHsv: function () {
        ...
        toName: function () {
          return 0 === this._a
            ? "transparent"
            : !(this._a < 1) && (A[e(this._r, this._g, this._b, !0)] || !1);
        },
        toFilter: function (t) {
