!(function (c, M) {
  ...
  function B(c, M) {
    var z, A;
    for (O(M), z = 0; z < M.length; z++)
      (A = M[z]), (q[A] = q[A] || {}), (q[A][c] = !0);
  }
  function r() {
    try {
    ...
    var z,
      ...
      o = (function () {
        var c,
          ...
          o = [b];
        for (z = 1; z < 48; z++)
          (M = new d(new Date(A, z, 1))).offset !== b.offset &&
            ((c = X(b, M)), o.push(c), o.push(new d(new Date(c.at + 6e4)))),
            (b = M);
        for (z = 0; z < 4; z++)
  ...
  function u(c, M) {
    ...
    return A instanceof W
      ...
      ? ((A = new W(A)), (p[c] = A))
      : n[c] && M !== u && (z = u(n[c], u))
      ? ((A = p[c] = new W())._set(z), (A.name = L[c]), A)
      : null;
  }
  function t(c) {
    var M, z, A, b;
  ...
  function R(c) {
    ...
    return (
      A && !o.isMoment(c) && E(b) && b.add(A.parse(b), "minutes"), b.tz(z), b
    );
  }
  (z < 2 || (2 === z && A < 6)) &&
    C(
      ...
      parse: function (c) {
        ...
        for (b = 0; b < a; b++)
          if (
            ...
            (z = p[b + 1]),
            (A = p[b ? b - 1 : b]),
            M < z && R.moveAmbiguousForward
              ? (M = z)
              : A < M && R.moveInvalidForward && (M = A),
            o < n[b] - 6e4 * M)
          )
            return p[b];
        return p[a];
    ...
    (o.updateOffset = function (c, M) {
      ...
      void 0 === c._z &&
        (A &&
          E(c) &&
          !c._isUTC &&
          ((c._d = o.utc(c._a)._d), c.utc().add(A.parse(c), "minutes")),
        (c._z = A)),
        c._z &&
          ((z = c._z.utcOffset(c)),
          Math.abs(z) < 16 && (z /= 60),
