  ...
  (t = function (M) {
    ...
    (M.cleanData =
      ...
      (M.widget = function (t, i, e) {
        ...
        return (
          e || ((e = i), (i = M.Widget)),
          M.isArray(e) && (e = M.extend.apply(null, [{}].concat(e))),
          (M.expr[":"][h.toLowerCase()] = function (t) {
            return !!M.data(t, h);
          }),
          (M[l] = M[l] || {}),
          (s = M[l][t]),
          ...
          s
            ? (M.each(s._childConstructors, function (t, e) {
                var i = e.prototype;
          ...
          for (e in s[n])
            (i = s[n][e]),
              s[n].hasOwnProperty(e) &&
                void 0 !== i &&
                (M.isPlainObject(i)
                  ? (t[e] = M.isPlainObject(t[e])
                      ? M.widget.extend({}, t[e], i)
                      : M.widget.extend({}, i))
                  : (t[e] = i));
        return t;
      }),
      ...
      (M.Widget.prototype = {
        ...
        destroy: function () {
          var i = this;
          this._destroy(),
            M.each(this.classesElementLookup, function (t, e) {
              i._removeClass(e, t);
            }),
            this.element
        ...
        option: function (t, e) {
          ...
          if ("string" == typeof t)
            if (((o = {}), (t = (i = t.split(".")).shift()), i.length)) {
              for (
                s = o[t] = M.widget.extend({}, this.options[t]), n = 0;
                n < i.length - 1;
                n++
              )
                (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
        ...
        _classes: function (n) {
          ...
          function t(t, e) {
            ...
            for (s = 0; s < t.length; s++)
              (i = a.classesElementLookup[t[s]] || M()),
                (i = n.add
                  ? M(M.unique(i.get().concat(n.element.get())))
                  : M(i.not(n.element).get())),
        ...
        _untrackClassesElement: function (i) {
          ...
          M.each(s.classesElementLookup, function (t, e) {
            -1 !== M.inArray(i.target, e) &&
              (s.classesElementLookup[t] = M(e.not(i.target).get()));
          });
        },
        ...
        _on: function (a, l, t) {
          var h,
            u = this;
          "boolean" != typeof a && ((t = l), (l = a), (a = !1)),
            t
              ? ((l = h = M(l)), (this.bindings = this.bindings.add(l)))
              : ((t = l), (l = this.element), (h = this.widget())),
            M.each(t, function (t, e) {
              function i() {
                if (
                  a ||
                  (!0 !== u.options.disabled &&
                    !M(this).hasClass("ui-state-disabled"))
                )
                  return ("string" == typeof e ? u[e] : e).apply(u, arguments);
              }
              "string" != typeof e &&
                (i.guid = e.guid = e.guid || i.guid || M.guid++);
              var s = t.match(/^([\w:-]*)\s*(.*)$/),
                n = s[1] + u.eventNamespace,
                o = s[2];
      ...
      (M.position = {
        ...
        (M.fn.position = function (c) {
          ...
          var d,
            ...
            i,
            g = M(c.of),
            v = M.position.getWithinInfo(c.within),
            b = M.position.getScrollInfo(v),
          ...
          return (
            ...
            "right" === c.at[0]
              ? (_.left += p)
              : "center" === c.at[0] && (_.left += p / 2),
            "bottom" === c.at[1]
              ? (_.top += m)
              : "center" === c.at[1] && (_.top += m / 2),
            (d = k(w.at, p, m)),
            (_.left += d[0]),
            (_.top += d[1]),
            this.each(function () {
              var i,
                ...
                e = O(this, "marginLeft"),
                s = O(this, "marginTop"),
                n = l + e + O(this, "marginRight") + b.width,
                o = h + s + O(this, "marginBottom") + b.height,
                u = M.extend({}, _),
              ...
              "right" === c.my[0]
                ...
                c.using &&
                  (t = function (t) {
                    ...
                    p < l && x(e + i) < p && (o.horizontal = "center"),
                      m < h && x(s + n) < m && (o.vertical = "middle"),
                      C(x(e), x(i)) > C(x(s), x(n))
          ...
          flip: {
            left: function (t, e) {
              var i,
                ...
                p = -2 * e.offset[0];
              u < 0
                ? ((i = t.left + c + d + p + e.collisionWidth - a - o) < 0 ||
                    i < x(u)) &&
                  (t.left += c + d + p)
                : 0 < r &&
                  (0 <
            ...
            top: function (t, e) {
              var i,
                ...
                p = -2 * e.offset[1];
              u < 0
                ? ((s = t.top + c + d + p + e.collisionHeight - a - o) < 0 ||
                    s < x(u)) &&
                  (t.top += c + d + p)
                : 0 < r &&
                  (0 <
                    (i =
                      t.top - e.collisionPosition.marginTop + c + d + p - l) ||
                    x(i) < r) &&
                  (t.top += c + d + p);
            },
          },
        ...
        return this[0].labels && this[0].labels.length
          ...
          : ((s = this.eq(0).parents("label")),
            (i = this.attr("id")) &&
              ...
              (e = "label[for='" + M.ui.escapeSelector(i) + "']"),
    ...
    M.widget("ui.controlgroup", {
      ...
      _initWidgets: function () {
        ...
        M.each(this.options.items, function (n, t) {
          ...
          (this.childWidgets = M(M.unique(l))),
      ...
      refresh: function () {
        ...
        this._addClass(
          ...
          n.length &&
            (M.each(["first", "last"], function (t, e) {
      ...
      M.ui.formResetMixin,
      {
        ...
        _getCreateOptions: function () {
          ...
          return (
            ...
            (this.label = M(e[e.length - 1])),
            this.label.length ||
              M.error("No label found for checkboxradio widget"),
            (this.originalLabel = ""),
            this.label
              .contents()
              .not(this.element[0])
              .each(function () {
                i.originalLabel +=
                  3 === this.nodeType ? M(this).text() : this.outerHTML;
              }),
        ...
        _getRadioGroup: function () {
          var t = this.element[0].name,
            e = "input[name='" + M.ui.escapeSelector(t) + "']";
          return t
            ? (this.form.length
                ? M(this.form[0].elements).filter(e)
                : M(e).filter(function () {
    ...
    M.widget("ui.button", {
      ...
      !1 !== M.uiBackCompat &&
        (M.widget("ui.button", M.ui.button, {
        ...
        (M.fn.button =
          ...
          function () {
            return !this.length ||
              ...
              : (M.ui.checkboxradio || M.error("Checkboxradio widget missing"),
                0 === arguments.length
        ...
        (M.fn.buttonset = function () {
          return (
            M.ui.controlgroup || M.error("Controlgroup widget missing"),
            "option" === arguments[0] &&
            "items" === arguments[1] &&
            arguments[2]
    ...
    M.ui.button,
      (M.ui.safeActiveElement = function (e) {
        var i;
        try {
          i = e.activeElement;
        } catch (t) {
      ...
      M.widget("ui.menu", {
          ...
          (this.activeMenu = this.element),
            ...
            this._on({
              ...
              "click .ui-menu-item": function (t) {
                var e = M(t.target),
                  i = M(M.ui.safeActiveElement(this.document[0]));
                !this.mouseHandled &&
              ...
              "mouseenter .ui-menu-item": function (t) {
                if (!this.previousFilter) {
                  var e = M(t.target).closest(".ui-menu-item"),
                    i = M(t.currentTarget);
                  e[0] === i[0] &&
                    (this._removeClass(
              ...
              blur: function (t) {
                this._delay(function () {
                  !M.contains(
                    this.element[0],
                    M.ui.safeActiveElement(this.document[0])
                  ) && this.collapseAll(t);
                });
              },
              keydown: "_keydown",
          ...
          this._toggleClass(
            ...
            (e = a
              ...
              .each(function () {
                var t = M(this),
                  e = t.prev(),
                  i = M("<span>").data("ui-menu-submenu-caret", !0);
            ...
            this.active &&
              !M.contains(this.element[0], this.active[0]) &&
              this.blur();
        },
        _itemRole: function () {
        ...
        collapseAll: function (e, i) {
          clearTimeout(this.timer),
            (this.timer = this._delay(function () {
              var t = i
                ? this.element
                : M(e && e.target).closest(this.element.find(".ui-menu"));
        ...
        _filterMenuItems: function (t) {
          ...
          return this.activeMenu
            ...
            .filter(function () {
              return i.test(
                M.trim(M(this).children(".ui-menu-item-wrapper").text())
              );
            });
        },
      }),
    ...
    M.widget("ui.mouse", {
        ...
        this.element
          ...
          .on("click." + this.widgetName, function (t) {
            if (!0 === M.data(t.target, e.widgetName + ".preventClickEvent"))
              return (
                M.removeData(t.target, e.widgetName + ".preventClickEvent"),
        ...
        if (!a) {
          ...
          var e = this,
            ...
            s =
              ...
              M(t.target).closest(this.options.cancel).length;
          return (
            ...
            !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 ===
                  M.data(t.target, this.widgetName + ".preventClickEvent") &&
                  M.removeData(
                    t.target,
        ...
        this.document
          ...
          this._mouseStarted &&
            ...
            t.target === this._mouseDownEvent.target &&
              M.data(t.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(t)),
        ...
        M.ui.formResetMixin,
        {
          ...
          _drawMenu: function () {
            ...
            (this.menu = M("<ul>", {
              ...
              (this.menuWrap = M("<div>").append(this.menu)),
          ...
          _position: function () {
            this.menuWrap.position(
              M.extend({ of: this.button }, this.options.position)
            );
          },
          close: function (t) {
            this.isOpen &&
          ...
          _renderItem: function (t, e) {
            var i = M("<li>"),
              s = M("<div>", { title: e.element.attr("title") });
            return (
          ...
          _documentClick: {
            mousedown: function (t) {
              this.isOpen &&
                (M(t.target).closest(
                  ".ui-selectmenu-menu, #" +
                    M.ui.escapeSelector(this.ids.button)
                ).length ||
                  this.close(t));
            },
          },
          ...
          _appendTo: function () {
            ...
            return (
              t &&
                (t =
                  t.jquery || t.nodeType ? M(t) : this.document.find(t).eq(0)),
      ...
      M.widget("ui.slider", M.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          (this.handles = s.add(M(n.join("")).appendTo(this.element))),
            this._addClass(
              this.handles,
              "ui-slider-handle",
              "ui-state-default"
            ...
            ? (!0 === t.range &&
                (t.values
                  ? t.values.length && 2 !== t.values.length
                    ...
                    : M.isArray(t.values) && (t.values = t.values.slice(0))
              ...
              this.range && this.range.length
                ...
                : ((this.range = M("<div>").appendTo(this.element)),
        ...
        _mouseCapture: function (t) {
          ...
          return (
            ...
            this.handles.each(function (t) {
              ...
              (e < s ||
                (s === e &&
                  (t === h._lastChangedValue || h.values(t) === u.min))) &&
                ((s = e), (n = M(this)), (o = t));
            }),
            !1 !== this._start(t, o) &&
            ...
            ? this.handles.each(function (t) {
                (i =
                  ...
                  (u["horizontal" === l.orientation ? "left" : "bottom"] =
                    i + "%"),
                  M(this).stop(1, 1)[h ? "animate" : "css"](u, a.animate),
                  !0 === l.options.range &&
        ...
        _handleEvents: {
          keydown: function (t) {
            var e,
              i,
              s,
              n = M(t.target).data("ui-slider-handle-index");
            switch (t.keyCode) {
              case M.ui.keyCode.HOME:
              case M.ui.keyCode.END:
              case M.ui.keyCode.PAGE_UP:
              ...
              case M.ui.keyCode.LEFT:
                if (
                  ...
                  !this._keySliding &&
                    ((this._keySliding = !0),
                    this._addClass(M(t.target), null, "ui-state-active"),
                    !1 === this._start(t, n)))
                )
                  return;
            }
          ...
          keyup: function (t) {
            ...
            this._keySliding &&
              ...
              this._stop(t, e),
              this._change(t, e),
              this._removeClass(M(t.target), null, "ui-state-active"));
          },
        },
      });
    function h(e) {
    ...
    M.widget("ui.spinner", {
      ...
      _events: {
        ...
        "mousedown .ui-spinner-button": function (t) {
          var e;
          function i() {
            this.element[0] === M.ui.safeActiveElement(this.document[0]) ||
          ...
          (e =
            ...
            !1 !== this._start(t) &&
              this._repeat(
                null,
                M(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1,
                t
              );
        },
      ...
      !1 !== M.uiBackCompat &&
        M.widget("ui.spinner", M.ui.spinner, {
          _enhance: function () {
            this.uiSpinner = this.element
              .attr("autocomplete", "off")
