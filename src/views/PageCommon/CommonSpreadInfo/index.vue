  ...
  <div class="container" v-loading="adminLoading">
    ...
    <div>
      <div class="admin_content">
        ...
        <ComSpreadTable ref="spreadsheetRef" :height="height" :tableData="tableData[0]" :tableColumns="tableColumns[0]"
          :tableLoading="tableLoading[0]" :remark="0" :sysID="ID" :pagination="tablePagination[0]"
...
export default {
  ...
  created() {
    ...
    if (routeBtn['name'].includes('data')) {
      this.isData = true
    }
  ...
  methods: {
    ...
    async getTableData(form, remarkTb) {
      this.$set(this.tableLoading, remarkTb, true);
      if (this.tableData[remarkTb].length === 0 && this.tableColumns[remarkTb].length >= 2) {
