  ...
  <div class="container" v-loading="adminLoading">
    ...
    <div>
      <div class="admin_content">
        ...
        <ComVxeTable :rowKey="'RowNumber'" ref="tableRef0" :height="height" :tableData="tableData[0]"
          :tableHeader="tableColumns[0]" :tableLoading="tableLoading[0]" :remark="0" :sysID="ID" :isEdit="isEdit"
          :isClear="isClear[0]" :hasSelect="isSelect" :pagination="tablePagination[0]" :keepSource="true"
          @selectfun="selectFun" @handleRowClick="handleRowClick" @pageChange="pageChange" @pageSize="pageSize"
...
export default {
  ...
  methods: {
    ...
    async dataSave(remarkTb, index, parms, newData) {
      ...
      console.log($table,'$table',this.$refs);

      const $table = this.$refs['tableRef0'].$refs.vxeTable;
