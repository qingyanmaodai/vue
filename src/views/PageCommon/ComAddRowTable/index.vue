...
<template>
  <div class="container" v-loading="adminLoading">
    <div class="admin_head" ref="headRef">
      <ComSearch ref="searchRef" :searchData="formSearchs[tagRemark].datas" :searchForm="formSearchs[tagRemark].forms"
        :remark="tagRemark" :isLoading="isLoading" :btnForm="btnForm" @btnClick="btnClick" />
    </div>
    <div class="admin_content">
          ...
          <el-col :span="20" class="flex_flex_end">
            ...
            <el-tooltip class="item" effect="dark" content="刷新" placement="bottom">
              <span class="right_icon">
                <span @click="refrshPage" role="img" aria-label="redo" class="anticon anticon-redo icon_size">
                  <svg class="" data-icon="redo" width="1em" height="1em" fill="currentColor" aria-hidden="true"
      ...
      <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" :height="height" :tableData="tableData[tagRemark]"
        :tableHeader="tableColumns[tagRemark]" :tableLoading="tableLoading[tagRemark]" :remark="tagRemark"
        :sysID="sysID[tagRemark].ID" :isEdit="isEdit" :isClear="isClear[tagRemark]"
        :pagination="tablePagination[tagRemark]" :hasSelect="true" @pageChange="pageChange" @pageSize="pageChange"
