...
export default {
  ...
  data() {
    return {
      ...
      parseSearch: false,
      Status1: [
        { label: "自然关闭", value: "自然关闭" },
        { label: "异常关闭", value: "分配不足" },
        { label: "终结", value: "终极关闭" },
        { label: "全部", value: "" },
      ],
      labelStatus1: 0,
  ...
  methods: {
    ...
    changeStatus(item, index) {
      ...
      if (index == 0 || index == 1) {
        this.formSearchs[0].datas["Close1"] = item.value;
        this.formSearchs[0].datas["Close2"] = "";
      } else if (index == 2) {
        this.formSearchs[0].datas["Close1"] = "";
        this.formSearchs[0].datas["Close2"] = item.value;
      } else {
        this.formSearchs[0].datas["Close1"] = "";
        this.formSearchs[0].datas["Close2"] = "";
      }
