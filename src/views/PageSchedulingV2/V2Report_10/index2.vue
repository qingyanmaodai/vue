...
export default {
  ...
  methods: {
    ...
    cellStyle0({ row, column }) {
      if (column.property == "NoIsSatisfy" || column.property == "Rresult") {
        if (row.NoIsSatisfy > 0) {
          return {
    ...
    handleRowClick(row, remarkTb) {
      ...
      // this.formSearchs[1].datas["NoIsSatisfy"] = 1;
      this.dataSearch(1);
    },
  },
};
