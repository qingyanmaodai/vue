<template>
  <div class="container flex_flex" v-loading="adminLoading">
        ...
        <div class="flex px-2 py-1.5 border-b-1 tree_Head">
          <div class="flex_flex_end flex-1">
            <el-input
              ...
              disabled
            ></el-input>
            <el-button type="primary" size="mini" @click="searchTree"
              >查询</el-button
            >
            <!-- <el-button
              type="warning"
    ...
    <el-dialog title="物料列表" :visible.sync="dialogShow2" width="70%">
      <ComSearch
        class="margin_bottom_10"
        ref="searchRef2"
    ...
    <el-dialog title="导入BOM模板" :visible.sync="dialogImport" width="30%">
      <el-upload
