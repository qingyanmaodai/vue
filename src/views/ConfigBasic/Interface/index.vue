  ...
  <div class="container" v-loading="adminLoading">
    ...
    <div>
      <div class="admin_content">
        <div class="ant-table-title">
          <el-row>
            ...
            <el-col :span="20" class="flex_flex_end">
              <el-button type="primary" size="mini" @click="addRow(0)" v-show="isAdd">新增</el-button>
        ...
        <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" :height="height" :tableData="tableData[0]"
          :tableHeader="tableColumns[0]" :tableLoading="tableLoading[0]" :remark="0" :sysID="sysID[0].ID" :isEdit="isEdit"
          :isClear="isClear[0]" :pagination="tablePagination[0]" @pageChange="pageChange" @pageSize="pageSize"
          @sortChange="sortChange" @OutputInter="OutputInter" @selectfun="selectFun" @handleRowClick="handleRowClick"
          @inputPar="inputPar" :keepSource="true" :hasSelect="true" />
      </div>
    </div>

    <!-- 输入参数表 -->
    <el-dialog :visible.sync="colDialogVisible1" width="80%" @closeDialog="colDialogVisible1 = false"
          ...
          <div class="admin_content">
            <div class="ant-table-title">
              <el-row>
                ...
                <el-col :span="20" class="flex_flex_end">
                  <el-button type="primary" size="mini" @click="addRow(1)" v-show="isAdd">新增</el-button>
                  <el-divider direction="vertical"></el-divider>
                </el-col>
              </el-row>
            </div>
            <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" height="650px" :tableData="tableData[1]"
              :tableHeader="tableColumns[1]" :tableLoading="tableLoading[1]" :remark="1" :sysID="sysID[1].ID"
              :isEdit="isEdit" :isClear="isClear[1]" :pagination="tablePagination[1]" @pageChange="pageChange"
              @pageSize="pageSize" @sortChange="sortChange" @toPageSetting="colDialogVisible1 = false" :hasSelect="true"
              @selectfun="selectFun" @inputParCon="inputParCon" />
          </div>
        </div>
      </div>
    ...
    <!-- 接口输出表 -->
    <el-dialog :visible.sync="colDialogVisible2" width="80%" @closeDialog="colDialogVisible2 = false"
      :close-on-click-modal="false">
      <div>
        <div class="admin_head" ref="headRef">
          <ComSearch ref="searchRef" :searchData="formSearchs[2].datas" :searchForm="formSearchs[2].forms" :remark="2"
            :isLoading="isLoading" :btnForm="btnForm" @btnClick="btnClick" />
        </div>
        <div>
          <div class="admin_content">
            <div class="ant-table-title">
              <el-row>
                ...
                <el-col :span="20" class="flex_flex_end">
                  <el-button type="primary" size="mini" @click="addRow(2)" v-show="isAdd">新增</el-button>
                  <el-divider direction="vertical"></el-divider>
                </el-col>
              </el-row>
            </div>
            <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" height="650px" :tableData="tableData[2]"
              :tableHeader="tableColumns[2]" :tableLoading="tableLoading[2]" :remark="2" :sysID="sysID[2].ID"
              :isEdit="isEdit" :isClear="isClear[2]" :pagination="tablePagination[2]" @pageChange="pageChange"
              @pageSize="pageSize" @sortChange="sortChange" @toPageSetting="colDialogVisible2 = false" :hasSelect="true"
              @selectfun="selectFun" @outputField="outputField" />
          </div>
        </div>
      </div>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 输出字段表 -->
    <el-dialog :visible.sync="colDialogVisible3" width="80%" @closeDialog="colDialogVisible3 = false"
      :close-on-click-modal="false">
      <div>
        <div class="admin_head" ref="headRef">
          <ComSearch ref="searchRef" :searchData="formSearchs[3].datas" :searchForm="formSearchs[3].forms" :remark="3"
            :isLoading="isLoading" :btnForm="btnForm" @btnClick="btnClick" />
        </div>
        <div>
          <div class="admin_content">
            <div class="ant-table-title">
              <el-row>
                ...
                <el-col :span="20" class="flex_flex_end">
                  <el-button type="primary" size="mini" @click="addRow(3)" v-show="isAdd">新增</el-button>
                  <el-divider direction="vertical"></el-divider>
                </el-col>
              </el-row>
            </div>
            <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" height="650px" :tableData="tableData[3]"
              :tableHeader="tableColumns[3]" :tableLoading="tableLoading[3]" :remark="3" :sysID="sysID[3].ID"
              :isEdit="isEdit" :isClear="isClear[3]" :pagination="tablePagination[3]" @pageChange="pageChange"
              @pageSize="pageSize" @sortChange="sortChange" @toPageSetting="
                (colDialogVisible3 = false), (colDialogVisible2 = false)
                " :hasSelect="true" @selectfun="selectFun" @outputField="outputField" />
          </div>
        </div>
      </div>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 参数配置表 -->
    <el-dialog :visible.sync="colDialogVisible4" width="80%" @closeDialog="colDialogVisible4 = false"
      :close-on-click-modal="false">
      <div>
        <div class="admin_head" ref="headRef">
          <ComSearch ref="searchRef" :searchData="formSearchs[4].datas" :searchForm="formSearchs[4].forms" :remark="4"
            :isLoading="isLoading" :btnForm="btnForm" @btnClick="btnClick" />
        </div>
        <div>
          <div class="admin_content">
            <div class="ant-table-title">
              <el-row>
                ...
                <el-col :span="20" class="flex_flex_end">
                  <el-button type="primary" size="mini" @click="addRow(4)" v-show="isAdd">新增</el-button>
                  <el-divider direction="vertical"></el-divider>
                </el-col>
              </el-row>
            </div>
            <ComVxeTable ref="ComVxeTable" :rowKey="'RowNumber'" height="650px" :tableData="tableData[4]"
              :tableHeader="tableColumns[4]" :tableLoading="tableLoading[4]" :remark="4" :sysID="sysID[4].ID"
              :isEdit="isEdit" :isClear="isClear[4]" :pagination="tablePagination[4]" @pageChange="pageChange"
              @pageSize="pageSize" @sortChange="sortChange" @toPageSetting="colDialogVisible4 = false" :hasSelect="true"
              @selectfun="selectFun" />
          </div>
        </div>
      </div>
