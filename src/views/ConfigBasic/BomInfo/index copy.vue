    ...
    data() {
      return {
        ...
        formController: [
          ...
          { label: "父件描述", prop: "ParentCode", type: "textarea" },
          // {
          //   label: "父件描述",
          //   prop: "ParentName",
          //   type: "selectTree",
          ...
          { label: "基本计量单位", prop: "ParentCode", type: "input" },
          {
            label: "用量",
            prop: "TotalPeoples",
            type: "input",
          ...
          { label: "损耗率", prop: "ParentCode", type: "input" },
          { label: "备注", prop: "ParentCode", type: "textarea" },
          {
            label: "状态",
            prop: "Status",
