          ...
          <el-row>
            ...
            >
              ...
              <el-select
                ...
                size="small"
                filterable
                v-model="headForm.SchedulingType"
                class="minShortInput"
              >
                <el-option
