...
export default {
  ...
  methods: {
    ...
    changeStatus(item, index) {
      ...
      if (index == 0) {
        this.formSearchs[0].datas["FormP1Name"] = "";
      } else if (index == 1) {
        this.formSearchs[0].datas["FormP1Name"] = 1;
      } else {
        this.formSearchs[0].datas["FormP1Name"] = 0;
      }
      this.dataSearch(0);
    },
    // 查看明细
    lookDetails(row, prop) {
      if (prop == "YesUnIssuedNum") {
        // 已发齐
        this.formSearchs[1].datas["SalesOrderDetailID"] =
          row.SalesOrderDetailID;
        this.formSearchs[1].datas["InspectStatus"] = 1;
        this.dataSearch(1);
        this.dialogShow = true;
      } else if (prop == "UnIssuedNum") {
        // 欠料项
        this.formSearchs[1].datas["SalesOrderDetailID"] =
          row.SalesOrderDetailID;
