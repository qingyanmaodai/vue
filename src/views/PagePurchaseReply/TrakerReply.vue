...
<template>
  <div class="APSContainer flex_flex" v-loading="adminLoading">
    ...
    <el-dialog title="料品可用量查询" :visible.sync="dialogShow1" width="50%">
...
export default {
  ...
  methods: {
    ...
    usingSearch(row, prop) {
      ...
      } else if (prop === 'SuplierReplyDate') {
        this.formSearchs[2].datas['SalesOrderNo'] = row.SalesOrderNo;
