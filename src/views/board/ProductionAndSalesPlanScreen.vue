    ...
    <div class="mainbox">
      <div class="row1">
        <div class="panel two line">
          ...
          <div class="chart1" v-loading="tableLoading[0]" element-loading-background="#060765">
        ...
        <div class="panel two pie">
          ...
          <div class="chart1" v-loading="tableLoading[1]" element-loading-background="#060765">
      ...
      <div class="row2">
        ...
        <div class="panel three bar1">
          ...
          <div class="chart2" v-loading="tableLoading[2]" element-loading-background="#060765">
          ...
          legend: {
            ...
            formatter: function (name) {
              ...
              _this.chartData1.map((item) => {
                if (item.name == name) {
                  prefect = ((item.value / _this.chartTotal1) * 100).toFixed(2) + '%';
                }
              });
              return name + '      ' + prefect;
            },
