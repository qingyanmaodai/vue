...
export default {
  ...
  data() {
    return {
      ...
      formController: [
          { label: "首次沟通时间", prop: "FirstCommunicationTime", type: "date" },
          { label: "当前状态", prop: "CurrentStatus", type: "select",
          select: [
                { label:"跟进中", value:"跟进中" },
                { label:"已入册", value:"已入册" },
                { label:"转合作", value:"转合作" },
          ...
          { label: "来源分类", prop: "SourceClassification", type: "select",
          select: [
              { label:"渠道", value:"渠道" },
              { label:"转介绍", value:"转介绍" },
              { label:"自访", value:"自访" },
              { label:"招聘广告", value:"招聘广告" },
              { label:"其他", value:"其他" }
          ]
          },
          { label: "来源说明", prop: "SourceDescription", type: "input" },
          { label: "姓名", prop: "Name", type: "input" },
          { label: "年龄", prop: "Age", type: "input" },
          { label: "证书情况", prop: "CertificateStatus", type: "input" },
          { label: "经验", prop: "Experience", type: "select",
          select: [
              { label:"无", value:"无" },
              { label:"有，1年以内", value:"有，1年以内" },
              { label:"有，2-3年", value:"有，2-3年" },
              { label:"有，3-5年", value:"有，3-5年" },
              { label:"有，5年以上", value:"有，5年以上" }
          ]
          },
          { label: "意向级别", prop: "IntentionLevel", type: "input" },
          { label: "籍贯:身份证所在地(省市区)", prop: "NativePlace", type: "input" },
          { label: "电话", prop: "Phone", type: "input" },
          { label: "目前所在地", prop: "CurrentLocation", type: "input" },
          { label: "跟进情况", prop: "FollowSituation", type: "input" },
          { label: "跟进计划", prop: "FollowPlan", type: "input" },
          { label: "备注", prop: "Remark", type: "input" },
          { label: "招生老师初试情况", prop: "FirstTestSituation", type: "input" },
          { label: "初试方式", prop: "FirstTestWay", type: "input" },
        // { label: "源名称", prop: "DataSouceName", type: "input" },
        // { label: "查询SQL", prop: "USQL", type: "textarea" },
        // { label: "显示字段", prop: "DataText", type: "input" },
        // { label: "保存字段", prop: "DataValue", type: "input" },
        // {
        //   label: "状态",
        //   prop: "Status",
 ...
 this.$store.getters.reduceHeight;
    ...
    async dataSys(importData) {
      if (importData && importData.length > 0) {
        ...
        var obj = {};
        obj["FirstCommunicationTime"] = m["首次沟通时间"];
        obj["CurrentStatus"] = m["当前状态"];
        obj["FollowPerson"] = m["跟进人"];
        obj["SourceClassification"] = m["来源分类"];
        obj["SourceDescription"] = m["来源说明"];
        obj["Name"] = m["姓名"];
        obj["Age"] = m["年龄"];
        obj["CertificateStatus"] = m["证书情况"];
        obj["Experience"] = m["经验"];
        obj["IntentionLevel"] = m["意向级别"];
        obj["NativePlace"] = m["籍贯:身份证所在地(省市区)"];
        obj["Phone"] = m["电话"];
        obj["CurrentLocation"] = m["目前所在地"];
        obj["FollowSituation"] = m["跟进情况"];
        obj["FollowPlan"] = m["跟进计划"];
        obj["Remark"] = m["备注"];
        obj["FirstTestSituation"] = m["招生老师初试情况"];
        obj["FirstTestWay"] = m["初试方式"];
        obj["dicID"] = 10256;
        DataList.push(obj);
        });
        // 保存导入的数据
