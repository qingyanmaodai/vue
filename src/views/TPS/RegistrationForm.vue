...
export default {
  ...
  data() {
    return {
      ...
      dialogShow: false,
      // 
      formData: { dicID:10254 },
      formController: [
          { label: "入库时间", prop: "WarehousingOn", type: "date" },
          { label: "渠道类型", prop: "ChannelType", type: "select",
          select: [
                { label:"培训机构", value:"培训机构" },
                { label:"职业学校", value:"职业学校" },
                { label:"家政", value:"家政" },
                { label:"个人", value:"个人" },
                { label:"其他", value:"其他" }
            ]
          },
          { label: "渠道名称", prop: "ChannelName", type: "input" },
          { label: "所在市", prop: "LocationCity", type: "input" },
          { label: "所在区", prop: "LocationArea", type: "input" },
          { label: "跟进人", prop: "FollowPerson", type: "input" },
          { label: "联系电话", prop: "ContactPhone", type: "input" },
          { label: "联系人", prop: "ContactName", type: "input" },
          { label: "联系人岗位", prop: "ContactPost", type: "input" },
          { label: "签约状态", prop: "SigningStatus", type: "input" },
          { label: "需要跟进", prop: "NeedFollow", type: "input" },
          ...
          { label: "当前合作状态", prop: "CurrentCooperationStatus", type: "select",
            select: [
                { label: "洽谈中", value: "洽谈中" },
                { label: "已签约未输送", value: "已签约未输送" },
                { label: "已签约输送中", value: "已签约输送中" },
                { label: "未签约输送中", value: "未签约输送中" },
                { label: "暂停输送", value: "暂停输送" },
                { label: "到期未续约", value: "到期未续约" }
            ]
          },
          { label: "登记人", prop: "Registrant", type: "input" },
          { label: "登记时间", prop: "RegistrationTime", type: "date" },
          { label: "跟进情况", prop: "FollowSituation", type: "input" },
          { label: "跟进计划", prop: "FollowPlan", type: "input" },
      ],
      formController1: [
        { label: "日期", prop: "FollowDate", type: "date" },
        { label: "计划", prop: "Plan", type: "input" },
 ...
 this.$store.getters.reduceHeight;
    ...
    async dataSys(importData) {
      if (importData && importData.length > 0) {
        ...
        var obj = {};
        obj["WarehousingOn"] = m["入库时间"];
        obj["ChannelType"] = m["渠道类型"];
        obj["ChannelName"] = m["渠道名称"];
        obj["LocationCity"] = m["所在市"];
        obj["LocationArea"] = m["所在区"];
        obj["FollowPerson"] = m["跟进人"];
        obj["ContactPhone"] = m["联系电话"];
        obj["ContactName"] = m["联系人"];
        obj["ContactPost"] = m["联系人岗位"];
        obj["SigningStatus"] = m["签约状态"];
        obj["NeedFollow"] = m["需要跟进"];
        obj["NormalStatus"] = m["状态"];
        obj["CurrentCooperationStatus"] = m["当前合作状态"];
        obj["Registrant"] = m["登记人"];
        obj["RegistrationTime"] = m["登记时间"];
