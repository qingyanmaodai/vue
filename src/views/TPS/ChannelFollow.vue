  ...
  data() {
    return {
      ...
      formController: [
          ...
          { label: "开设课程(全部)", prop: "OpenCourse", type: "input" },
          { label: "母婴班每期学员", prop: "StudentQty", type: "input" },
          { label: "每月开班数", prop: "MonthClassNum", type: "input" },
          { label: "每月开班时间", prop: "ClassStartOn", type: "date" },
          { label: "每月结课时间", prop: "ClassEndOn", type: "date" },
          { label: "其他合作就业情况", prop: "Other", type: "input" },
          { label: "备注", prop: "Remark", type: "input" },
          { label: "跟进情况", prop: "FollowSituation", type: "input" },
          { label: "跟进计划", prop: "FollowPlan", type: "input" },
          { label: "在册数", prop: "OnlineQty", type: "input" },
          { label: "离册数", prop: "OfflineQty", type: "input" }
 ...
 this.$store.getters.reduceHeight;
    ...
    async dataSys(importData) {
      if (importData && importData.length > 0) {
        ...
        obj["OpenCourse"] = m["开设课程(全部)"];
        obj["StudentQty"] = m["母婴班每期学员"];
        obj["MonthClassNum"] = m["每月开班数"];
        obj["ClassStartOn"] = m["每月开班时间"];
        obj["ClassEndOn"] = m["每月结课时间"];
        obj["Other"] = m["其他合作就业情况"];
        obj["Remark"] = m["备注"];
        obj["FollowSituation"] = m["跟进情况"];
        obj["FollowPlan"] = m["跟进计划"];
        obj["OnlineQty"] = m["在册数"];
        obj["OfflineQty"] = m["离册数"];
        obj["dicID"] = 10255;
        DataList.push(obj);
        });
        // 保存导入的数据
