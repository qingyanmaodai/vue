...
<template>
  <div class="container" v-loading="adminLoading">
    ...
    <ComFormDialog
      ref="sourceForm"
      :title="'新增其他'"
      :dialogShow="dialogShow4"
      :remark="4"
      :formData="formData"
      :formRules="formRules"
      :formController="formController4"
      @dialogBtnClick="dialogBtnClick"
    />
    <ComFormDialog
      ref="sourceForm"
      :title="'新增体检情况'"
      :dialogShow="dialogShow5"
      :remark="5"
      :formData="formData"
      :formRules="formRules"
      :formController="formController5"
      @dialogBtnClick="dialogBtnClick"
    />
    <ComFormDialog
      ref="sourceForm"
      :title="'新增累计上单情况'"
      :dialogShow="dialogShow6"
      :remark="6"
      :formData="formData"
      :formRules="formRules"
      :formController="formController6"
      @dialogBtnClick="dialogBtnClick"
    />
  ...
  data() {
    return {
      ...
      formController2: [
        ...
        { label: "晋升日期", prop: "PromotionOn", type: "date" },
        { label: "备注说明", prop: "Remark1", type: "input" },
      ],
      formController3: [
        { label: "身份证号码", prop: "IDCard", type: "input" },
      ...
      formController4: [
        { label: "身份证号码", prop: "IDCard", type: "input" },
        { label: "有无上户经验", prop: "HouseholdExperience", type: "input" },
        { label: "报读时间", prop: "RegistrationDate", type: "date" },
        { label: "报读科目", prop: "RegisteredSubjects", type: "input" },
        { label: "开单人", prop: "Drawer", type: "input" },
        { label: "渠道", prop: "Channel", type: "input" },
        { label: "已收学费", prop: "ReceivedTuition", type: "input" },
        { label: "入册费缴交日期", prop: "PayDate", type: "date" },
        { label: "首月已扣入册费", prop: "FirstDeductFee", type: "input" },
        { label: "渠道费", prop: "ChannelFee", type: "input" },
        { label: "收款人", prop: "Payee", type: "input" },
        { label: "收款人电话", prop: "PayeePhone", type: "input" },
        { label: "开户银行", prop: "DepositBank", type: "input" },
        { label: "推荐人银行账号", prop: "RecommenderBankNum", type: "input" },
        { label: "毕业时间", prop: "GraduationDate", type: "date" },
        { label: "理论", prop: "Theory", type: "input" },
        { label: "实操", prop: "PracticalOperation", type: "input" },
      ],
      formController5: [
        { label: "身份证号码", prop: "IDCard", type: "input" },
        ...
        { label: "失效", prop: "Invalid", type: "input" },
        { label: "备注", prop: "Remark", type: "input" },
        { label: "检查单位", prop: "InspectionUnit", type: "input" },
        { label: "需要重检", prop: "Recheck", type: "input" },
      ],
      formController6: [
        { label: "身份证号码", prop: "IDCard", type: "input" },
        { label: "年份", prop: "Year", type: "input" },
        { label: "接单", prop: "OrderReceive", type: "input" },
        { label: "完成", prop: "Complete", type: "input" },
        { label: "客诉", prop: "GuestComplaint", type: "input" },
        { label: "客诉记录", prop: "CustomerComplaintRecord", type: "input" },
      ],
      formRules: {
        // DataSouceName: [
  ...
  methods: {
    ...
    sureImport() {
      ...
      if (this.importStatus == -1) {
        ...
        remarkTb = 3;
      } else if (this.importStatus == 4) {
        remarkTb = 4;
      } else if (this.importStatus == 5) {
        remarkTb = 5;
      }
