  ...
  data() {
    return {
      ...
      formController: [
          ...
          { label: "选择套餐/价格", prop: "Package", type: "input" },
          ...
          { label: "服务时间", prop: "ServiceDate", type: "input" },
          { label: "天数1", prop: "Days1", type: "input" },
          { label: "备注1", prop: "Remark1", type: "input" },
          { label: "是否收取尾款", prop: "CollectRemainderBalance", type: "input" },
          { label: "服务回访过程记录", prop: "ReturnRecord", type: "input" },
      ],
      formRules: {
        // DataSouceName: [
 ...
 this.$store.getters.reduceHeight;
    ...
    async dataSys(importData) {
      if (importData && importData.length > 0) {
        ...
        obj["ServiceDate"] = m["服务时间"];
        obj["Days1"] = m["天数1"];
        obj["Remark1"] = m["备注1"];
        obj["CollectRemainderBalance"] = m["是否收取尾款"];
        obj["ReturnRecord"] = m["服务回访过程记录"];
        obj["dicID"] = 10265;
        DataList.push(obj);
        });
        // 保存导入的数据
