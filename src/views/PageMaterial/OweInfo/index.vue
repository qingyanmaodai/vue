    ...
    <div>
      ...
      <div class="admin_content">
        <div>
          ...
          >
            <vxe-column type="seq" min-width="60" title="序号"></vxe-column>
            <vxe-column
          ...
          <div class="flex_row_spaceBtn pagination">
            ...
            <div class="flex">
              <el-pagination
                ...
                :page-sizes="[
                  100, 300, 500, 700, 900, 1200, 1500, 2000, 3000, 4000, 5000,
                ]"
      ...
      <div class="container" style="background-color: #f0f2f5">
        <div class="admin_head">
          <div>
            ...
            <el-divider direction="vertical"></el-divider>
            <span>{{ currentRow.MaterialName }}</span>
            <el-divider direction="vertical"></el-divider>
            <span>{{ currentRow.Spec }}</span>
            <el-divider direction="vertical"></el-divider>
            <span>[单位:{{ currentRow.Spec }}]</span>
            <el-divider direction="vertical"></el-divider>
            <span>[单位换算率:{{ currentRow.Spec }}]</span>
            <el-divider direction="vertical"></el-divider>
            <span>[安全库存量:{{ currentRow.Spec }}]</span>
            <el-divider direction="vertical"></el-divider>
            <span>[最少购量:{{ currentRow.Spec }}]</span>
            <el-divider direction="vertical"></el-divider>
            <span>[购货倍数:{{ currentRow.Spec }}]</span>
          </div>
          <div>
            <span>
              [可用量:{{ dialogForm.one }}]=<span style="color: Red"
                >[库存:{{ dialogForm.one }}]</span
              >+[WIP:{{ dialogForm.one2 }}]
            </span>
          </div>
        </div>
