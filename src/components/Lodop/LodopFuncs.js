    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if (!LODOP) {
                ...
                lopdopHtml = strCLodopInstall_1 + (CLodopIsLocal ? strCLodopInstall_2 : "") + strCLodopInstall_3;
                return;
            } else {
                if (CLODOP.CVERSION < "4.1.0.4") {
                    // document.body.innerHTML = strCLodopUpdate + document.body.innerHTML;
                    lopdopHtml = strCLodopUpdate;
                }
            ...
            if ((!LODOP) || (!LODOP.VERSION)) {
                if (ua.indexOf('Chrome') >= 0)
                    ...
                    lopdopHtml = strHtmChrome;
                if (ua.indexOf('Firefox') >= 0)
                    // document.body.innerHTML = strHtmFireFox + document.body.innerHTML;
                    lopdopHtml = strHtmFireFox;
                // document.body.innerHTML = (is64IE ? strHtm64_Install : strHtmInstall) + document.body.innerHTML;
                lopdopHtml = is64IE ? strHtm64_Install : strHtmInstall;
                return LODOP;
            }
        }
        if (LODOP.VERSION < "6.2.2.6") {
            if (!needCLodop())
                ...
                lopdopHtml = is64IE ? strHtm64_Update : strHtmUpdate;
        }
        //===如下空白位置适合调用统一功能(如注册语句、语言选择等):==
        LODOP.SET_LICENSES("广东新宝电器股份有限公司", "471ED94DFAE17DF0B3A01D8C7E83CA30", "廣東新寶電器股份有限公司", "0F75B80ADE365DCA5EECC8BFABC9208C");
        LODOP.SET_LICENSES("THIRD LICENSE", "", "Guangdong Xinbao Electrical Appliances Holdings Co.,Ltd", "A192552BC0CFD730E92FABB8C6EE3BE6");
